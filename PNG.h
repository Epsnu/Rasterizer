 ...
 * @file PNG.h
 *
 * Heavily written by CS225 class but I'm using it slightly differently with RBGPixel
 */
...
class PNG {
  public:
    ...
    /**
     * Gets the difference between images of the same size
     * Uses absolute difference, no negatives
     * @param other Image to subtract from current image
     * @return Image representing difference between the two
     */
    PNG diff(PNG const & other);
